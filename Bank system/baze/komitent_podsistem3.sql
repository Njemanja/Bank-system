/*
-- Query: SELECT * FROM banka_backup.komitent
LIMIT 0, 1000

-- Date: 2022-02-25 02:40
*/
INSERT INTO `komitent` (`IDKom`,`Naziv`,`Adresa`,`IDMes`) VALUES (1,'Aleksandar Markovic','Dimitrija Tucovica 12',9);
